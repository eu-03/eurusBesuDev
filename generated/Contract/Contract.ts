...
export class Contract__getGravatarResult {
  value0: string;
  value1: string;
...
export class Contract__gravatarsResult {
  value0: Address;
  value1: string;
  value2: string;
...
export class Contract extends ethereum.SmartContract {
  ...
  getGravatar(owner: Address): Contract__getGravatarResult {
    ...
    return new Contract__getGravatarResult(
      result[0].toString(),
      result[1].toString()
    );
  }
  ...
  try_getGravatar(
    owner: Address
  ): ethereum.CallResult<Contract__getGravatarResult> {
    ...
    return ethereum.CallResult.fromValue(
      new Contract__getGravatarResult(value[0].toString(), value[1].toString())
    );
  }
  ...
  gravatars(param0: BigInt): Contract__gravatarsResult {
    let result = super.call(
      "gravatars",
    ...
    return new Contract__gravatarsResult(
      result[0].toAddress(),
      result[1].toString(),
      result[2].toString()
    );
  ...
  try_gravatars(
    param0: BigInt
  ): ethereum.CallResult<Contract__gravatarsResult> {
    let result = super.tryCall(
      "gravatars",
      "gravatars(uint256):(address,string,string)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
